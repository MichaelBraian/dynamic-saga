...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-auto items-center justify-between space-x-1 overflow-hidden rounded-sm border p-1 shadow-sm",
  {
    variants: {
      variant: {
        default: "border-0 bg-background/60 backdrop-blur-sm text-foreground",
        destructive: "destructive group border-0 bg-destructive/60 backdrop-blur-sm text-destructive-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
