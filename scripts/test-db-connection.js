...
var testConnection_1 = require("../src/lib/db/testConnection");
function runTests() {
    return __awaiter(this, void 0, void 0, function () {
        var connectionResult, tableResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('Testing database connection...\n');
                    return [4 /*yield*/, (0, testConnection_1.testDatabaseConnection)()];
                case 1:
                    ...
                    return [4 /*yield*/, (0, testConnection_1.testTableAccess)()];
                case 2:
                    tableResult = _a.sent();
